Отличный текст! Я дописал его, добавив **все картинки** (как в примере с авокадо), красивые эмодзи и немного отформатировал. Вот **полностью готовый README.md** — просто скопируйте и замените им текущий:
...
Теперь всё, как в примере с авокадо: красивые значки, картинки вставлены в нужные места, структура чёткая. Просто скопируйте этот текст и замените им содержимое вашего `README.md` на GitHub. После этого картинки будут отображаться прямо в тексте!
